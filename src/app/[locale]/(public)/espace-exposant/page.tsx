...
export const metadata = {
  title: 'Espace Exposant — MediaDays Solutions 2026',
};
...
export default async function EspaceExposantPage({ params, searchParams }: PageProps) {
...
function Content({
  ...
  const t = useTranslations('espaceExposant');
  const tForm = useTranslations('espaceExposant.requestLink');
  const tLogin = useTranslations('espaceExposant.login');
