 ...
 *
 * Garanties testees :
 *   - 11 sections (full menu pour exposant)
 ...
 *   - filterNavItemsForProfile : exposant voit toutes les sections
...
describe('EXPOSANT_NAV_ITEMS', () => {
  it('expose 11 sections (full menu exposant incl. profil + preferences-email)', () => {
...
describe('filterNavItemsForProfile (P8.2)', () => {
  ...
  it('exposant : voit toutes les sections (11)', () => {
    const items = filterNavItemsForProfile(
      EXPOSANT_NAV_ITEMS,
      makeProfile({ is_exposant: true, has_stand: true }),
    );
