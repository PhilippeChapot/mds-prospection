...
import { getSupplementaryOrderDetail } from '@/lib/espace-exposant/supplementary-orders/queries';
import { formatEurHt } from '@/lib/tarifs/format';

export const dynamic = 'force-dynamic';
export const metadata = { title: 'Détail commande — Espace Exposant' };
...
export default async function CommandeDetailPage({ params, searchParams }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      <Link
        href={`/${locale}/espace-exposant/dashboard/commandes`}
