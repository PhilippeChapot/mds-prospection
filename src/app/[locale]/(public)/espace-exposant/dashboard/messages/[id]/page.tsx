...
export default async function EspaceExposantConversationPage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      <Link
        href={`/${localeSafe}/espace-exposant/dashboard/messages`}
      ...
      <section className="border-md-border bg-card space-y-2 rounded-xl border p-4 shadow-sm">
        ...
        <ExposantConversationReplyForm conversationId={conversation.id} locale={localeSafe} />
      </section>
    </div>
  );
}
