...
vi.mock('@/lib/espace-exposant/session', () => ({
  requireEspaceExposantSession: vi.fn(async () => ({ prospectId: 'prospect-uuid-1' })),
}));
...
vi.mock('@/lib/espace-exposant/supplementary-orders/queries', () => ({
  getProspectForExposant: vi.fn(async () => mockProspect),
