...
} from '@/lib/espace-exposant/supplementary-orders/eligibility';
      ...
      <Card className="border-md-border space-y-4 p-6 shadow-sm sm:p-8">
        ...
        <div className="flex flex-wrap justify-center gap-2 pt-2">
          <Button asChild variant="outline" size="sm">
            <Link href={`/${locale}/espace-exposant/dashboard/documents`}>Voir mon devis</Link>
          </Button>
          <Button asChild size="sm">
            <Link href={`/${locale}/espace-exposant/dashboard/stand`}>Retour au dashboard</Link>
          </Button>
        </div>
      </Card>
    </div>
