...
import { updateExposantContactAction } from './actions';
...
export function ContactInfoForm({
  ...
  const t = useTranslations('espaceExposant.dashboard.contactInfo');
            ...
            <Button
              ...
              onClick={() =>
                startTransition(async () => {
                  setError(null);
                  const result = await updateExposantContactAction({
