...
export function RequestMagicLinkForm({ locale }: { locale: 'fr' | 'en' }) {
  const t = useTranslations('espacePartenaire.requestLink');
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const response = await fetch('/api/espace-partenaire/request-magic-link', {
        method: 'POST',
