...
/**
 * P5.x.17 — burger menu mobile pour l'Espace Partenaire V1.3.
 *
 ...
 */
export function PartenaireMobileMenu({ profile }: { profile: ContactProfile | null }) {
  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="w-72 p-0">
        ...
        <PartenaireSidebar onNavigate={() => setOpen(false)} profile={profile} />
      </SheetContent>
    </Sheet>
  );
}
