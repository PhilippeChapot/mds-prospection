...
/**
 * P5.x.17-ter — bouton de logout pour l'Espace Partenaire V1.3.
 *
 ...
 * redirect vers /espace-partenaire apres delete cookie. Le navigateur
 * suit le 303.
 */
interface Props {
...
export function LogoutButton({ onLogout, label }: Props) {
  ...
  return (
    <form action={`/${locale}/espace-partenaire/logout`} method="post">
      <button
        type="submit"
        onClick={onLogout}
