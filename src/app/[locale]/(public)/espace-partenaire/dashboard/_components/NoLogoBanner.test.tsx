...
describe('NoLogoBanner (P5.x.18)', () => {
  it('rend title + description + CTA depuis les props', () => {
    render(
      <NoLogoBanner
        ...
        uploadHref="/fr/espace-partenaire/dashboard/kit-communication#logo-uploader"
      />,
    );
  ...
  it('le CTA pointe vers uploadHref avec ancre #logo-uploader', () => {
    ...
    expect(link).toHaveAttribute(
      'href',
      '/fr/espace-partenaire/dashboard/kit-communication#logo-uploader',
    );
  });
  ...
  it('respecte un uploadHref en locale en', () => {
    render(
      <NoLogoBanner
        ...
        uploadHref="/en/espace-partenaire/dashboard/kit-communication#logo-uploader"
      />,
    );
    const link = screen.getByText(/Add my logo/).closest('a');
    expect(link).toHaveAttribute(
      'href',
      '/en/espace-partenaire/dashboard/kit-communication#logo-uploader',
    );
  });
