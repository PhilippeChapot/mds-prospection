...
/**
 * P9.2 — bouton "+ Contacter l'equipe MDS" cote partenaire.
 *
...
export function NewPartenaireConversationButton({ locale }: { locale: 'fr' | 'en' }) {
  const t = COPY[locale];
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      setOpen(false);
      router.push(`/${locale}/espace-partenaire/dashboard/messages/${r.conversation_id}`);
    });
  }
