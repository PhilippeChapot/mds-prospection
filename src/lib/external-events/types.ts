...
export const EVENT_DISPLAY_CONFIGS: Record<ExternalEventKey, EventDisplayConfig> = {
  prs: {
    ...
    titleFr: 'Partenaire Paris Radio Show',
    titleEn: 'Paris Radio Show partner',
  },
  mediadays_classic: {
    ...
    titleFr: 'Partenaire MediaDays Classic (Havas)',
    titleEn: 'MediaDays Classic partner (Havas)',
  },
  rde: {
    key: 'rde',
    label: 'RDE',
    ...
    titleFr: 'Partenaire Radio Days Europe',
    titleEn: 'Radio Days Europe partner',
  },
  satis: {
    key: 'satis',
    label: 'SATIS',
    ...
    titleFr: 'Partenaire SATIS',
    titleEn: 'SATIS partner',
  },
  cbd: {
    key: 'cbd',
    label: 'CBD',
    ...
    titleFr: 'Partenaire Broadcast Days',
    titleEn: 'Broadcast Days partner',
  },
};
