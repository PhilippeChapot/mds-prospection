...
const COUNTRY_ALIASES: Record<string, string> = {
  ...
  JAPAN: 'JP',
  JAPON: 'JP',
  // P5.x.RestoreCountryFromXlsx — variantes FR + pays des exports radios
  // (ConnectOnAir mondial). Clés après strip-accents + upper.
  'GRANDE BRETAGNE': 'GB',
  ANGLETERRE: 'GB',
  'ETATS UNIS': 'US',
  ...
  'ARABIE SAOUDITE': 'SA',
  // Afrique francophone (radios ConnectOnAir)
  MAROC: 'MA',
  ALGERIE: 'DZ',
  TUNISIE: 'TN',
  SENEGAL: 'SN',
